...
def validate(
    ...
    *,
    ...
    :param model: A 3-D `BlackOil` instance.
...
def _validate_pressure_gradient(model: BlackOil, report: ValidationReport) -> None:
    """
...
def _validate_transmissibility(model: BlackOil, report: ValidationReport) -> None:
    """
